...
Software engineer with 12 years of experience in embedded systems and controls. Most recently delivering precision agriculture software solutions using modern C++ and Qt frameworks.

% Objective
% \section{Objective}
% Obtain a job as a software engineer focusing on embedded systems.
...
\skill{Embedded Systems} & \skill{Robotics} & \skill{PID Control} \\[5pt]
\skill{GCC} & \skill{CMake} & \skill{Conan} \\[5pt]
\skill{Software Design} & \skill{OpenGL} & \skill{Computer Vision} \\[5pt]
\skill{CAN/J1939/ISOBUS} & \skill{Precision Agriculture} & \skill{ }  \\[5pt]
\end{tabularx}
};
\end{tikzpicture}
...
{\large\textcolor{forestgreen}{\textbf{FIRST Robotics Competition}}} \hfill FRC Team Neutrino 4H
\begin{itemize}[leftmargin=*,itemsep=2pt]
\item Lead and Controls Mentor FRC Team Neutrino 4H 
\end{itemize}
