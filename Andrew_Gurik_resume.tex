...
\project{Drivetrain Systems \& Software -- Large Mining Trucks \& Off Highway Trucks}{
    ...
    \item Maintianed existing features using hydraulic solenoid control, J1939 communication, and speed sensor inputs while validating behavior with hardware-in-loop and software-in-loop testing.
}
% Volunteer Section
