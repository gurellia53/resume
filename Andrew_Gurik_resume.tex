...
% Header
\begin{center}
{\huge \textcolor{forestgreen}{\textbf{Andrew G. Gurik}}}\\[3pt]
    {\normalsize
...
\noproject{Currently building vision-based vehicle automation using VPI AprilTag Detector on NVIDIA Jetson.}
\project{In-Cab Touchscreen Display -- InCommand Go}{
    ...
    \item Integrated a new 3D map engine with a legacy codebase while improving graphics performance using profiling and optimization.
    \item Developed custom OpenGL ES shaders to improve rendering performance and visual quality.
}
\project{Liquid Application Control -- L2 \& RightSpot}{
    ...
    \item Designed a CAN protocol to communicate with third-party nozzle-by-nozzle systems and implemented nozzle duty-cycle control.
...
\project{High Speed Planting -- SureSpeed}{
    \item Developed a high-speed planting system using BLDC motors (seed meter and seed tube) with proprietary sensors communicating over J1939.
    \item Implemented touch-based in-cab diagnostics to improve troubleshooting and operator workflow.
    \item Brought up a modified hardware platform (MPC5634) while maintaining compatibility with preexisting systems such as hydraulic downforce.
}
...
\project{Caterpillar -- Core Machine Software}{
    ...
    \item Integrated Simulink models, custom C\#/C++ tooling, GTest, and a virtual CAN bus.
}
\employer{Caterpillar, Inc.}{Software Engineer}{2013 - 2016}
\project{Drivetrain Systems \& Software - Large Mining Trucks}{
    \item Maintained and extended powershift transmission control software in C and Simulink, delivering feature development and bug fixes.
}
